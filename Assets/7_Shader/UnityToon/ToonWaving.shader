...
Shader "ToonWaving" {
    Properties {
        ...
        _WaveRange ("Wave Range", Range(0, 2)) = 1
...
// HDRP Variant
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            #pragma target 4.5	    
            #include "Packages/com.unity.toonshader/Runtime/HDRP/Shaders/UtsHDRP.hlsl"
...
//	    #pragma multi_compile USE_FPTL_LIGHTLIST USE_CLUSTERED_LIGHTLIST
            ...
            #include "Packages/com.unity.toonshader/Runtime/HDRP/Shaders/UtsLightLoop.hlsl"
            #include "Packages/com.unity.toonshader/Runtime/HDRP/Shaders/ShaderPassForwardUTS.hlsl"
#endif
            #pragma vertex Vert
            #pragma fragment Frag
...
#ifdef UNITY_SHADER_VARIABLES_INCLUDED
            #include "Packages/com.unity.toonshader/Runtime/HDRP/Shaders/HDRPToonHead.hlsl"
            #include "Packages/com.unity.toonshader/Runtime/HDRP/Shaders/HDRPToonOutline.hlsl"
#endif
...
//            #pragma shader_feature _OCCLUSIONMAP
            ...
            #include "Assets/7_Shader/UnityToon/hlsl/WavingToonBody.hlsl"
#endif
            ENDHLSL
        ...
        Pass {
            ...
            #include "Packages/com.unity.toonshader/Runtime/UniversalRP/Shaders/UniversalToonInput.hlsl"
            #include "Packages/com.unity.toonshader/Runtime/UniversalRP/Shaders/UniversalToonHead.hlsl"
            #include "Assets/7_Shader/UnityToon/hlsl/WavingToonOutline.hlsl"
#endif
            ENDHLSL
        }
...
#include "Packages/com.unity.toonshader/Runtime/Legacy/Shaders/UCTS_ShadingGradeMap.cginc"


#else //#if defined(_SHADINGGRADEMAP)

#include "Packages/com.unity.toonshader/Runtime/Legacy/Shaders/UCTS_DoubleShadeWithFeather.cginc"
        ...
        Pass {
            ...
            #include "Packages/com.unity.toonshader/Runtime/Legacy/Shaders/UCTS_Outline.cginc"
            ENDCG
        }
        Pass {
            Name "FORWARD_DELTA"
...
#include "Packages/com.unity.toonshader/Runtime/Legacy/Shaders/UCTS_DoubleShadeWithFeather.cginc"
        ...
        Pass {
            ...
            //v.2.0.4
            #pragma shader_feature _IS_CLIPPING_OFF _IS_CLIPPING_MODE _IS_CLIPPING_TRANSMODE
            #include "Packages/com.unity.toonshader/Runtime/Legacy/Shaders/UCTS_ShadowCaster.cginc"
            ENDCG
        }
//ToonCoreEnd
    }
